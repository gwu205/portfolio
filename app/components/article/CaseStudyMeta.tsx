...
export const CaseStudyMeta = ({
  ...
  return (
    <>
      <section className="relative flex flex-col items-center justify-center overflow-hidden sm:min-h-[300px] h-[200px] sm:h-[50vh]">
      ...
      <section className="relative bg-white p-5 sm:p-10">
        <div className="flex max-lg:flex-col max-w-6xl mx-auto">
          <div className="meta max-sm:[&>*]:w-full max-lg:[&>*]:w-1/2 flex flex-col max-lg:flex-row max-lg:gap-y-2 lg:gap-4 w-full lg:w-[330px] max-lg:flex-wrap max-lg:items-start shrink-0 h-fit p-12 lg:-mt-[25vh] bg-[#F7F4F8] rounded-[32px] z-10">
          ...
          <div className="w-full px-0 pt-16 lg:px-16 lg:pb-8">
            ...
            <p className="u-stack-label text-[#4E3960] opacity-50 mb-6">
