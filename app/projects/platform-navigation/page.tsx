    ...
    <>
      ...
      <main className="article">
        <div className="content">
          <h2>The Problem</h2>
          <p>
            At launch, Sollective focused solely on freelancer-to-business
            matching. However, its scope has since expanded to include
            freelancer productivity tools and business administration features.
          </p>
          <p>
            As the platform’s offerings grew, so did its audience, attracting
            not only job seekers but also users searching for productivity
            solutions. This expansion presented a critical challenge:
          </p>
          <ul>
            <li>
              How could the platform’s <b>information architecture</b> and{" "}
              <b>feature prioritisation</b> evolve to showcase its new
              capabilities?
            </li>
            <li>
          ...
          <p>
            ...
            scalability, leading to difficulties for freelancers and recruiters
            in navigating between tools like job postings, contracts, and
            messaging.
          </p>
          <Image
          ...
          />
          <p>
            The core issue of the existing navigation was in the discoverability
            of features and scalability. This had the impact of freelancers and
            recruiters struggling to find tools and navigate between job
            postings, contracts, and messaging.
          </p>
          <h2>The Solution</h2>
          ...
          <aside className="max-w-3xl bg-[#F7F4F8] rounded-lg my-8 py-7 md:py-20 px-5 md:px-12 font-medium md:font-light text-lg md:text-4xl/snug text-slate-400 bg-white">
            How might we{" "}
            <span className="text-purple-400">
              effectively inform users of everything that the product offers
              while easing them into the user experience?
            </span>
          </aside>
          ...
          <p>
            ...
            app-like icon affordance, we explored ways to separate and
            streamline user flows. This approach allows users to focus on a
            single task or feature without distraction, reducing overwhelm and
            enhancing usability.
          </p>
          <Image
          ...
          <ul>
            <li>
              Iteration 1: A slide-out menu that locks the interface when
              activated.
            </li>
            <li>
          ...
          <p>
            Users favored a full-height menu, finding it approachable and easy
            to navigate. Some expressed interest in a fixed side menu, but we
            determined this wasn’t ideal for Sollective’s highly focused user
            flows.
          </p>
          <p className="subheading">Final Design</p>
          <p>
            We adopted a hybrid navigation system featuring a top navigation bar
            complemented by a collapsible main menu. This structure balances
            clarity and accessibility while reducing cognitive load.
          </p>
          <Image
          ...
          <p>
            This project underscored the importance of grounding design
            decisions in user feedback and competitive insights. While every
            platform has unique needs, designing for scalability and clarity
            ensures a foundation for long-term success.
          </p>
        </div>
      </main>
      <Footer type="article" />
